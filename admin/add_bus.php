...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage Bus | Add Bus</title>
									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"insert into tbl_bus (Bus_no,Bus_photos,Bus_type,Bus_is_active) values ('$busno','$bus_photo','$type','$isactive')") or die(mysqli_error($conn));
												if($result==true)
												{
