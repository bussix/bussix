...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage News | Add News</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Manage News</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<!-- <li class="breadcrumb-item">
												<a href="#" class="text-muted">Manage Add News</a>
											</li> -->
											<li class="breadcrumb-item">
												<a href="add news.php" class="text-muted">Add News</a>
											</li>
								...
								<div class="row">
									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											...
											{
												$ext = pathinfo($_FILES["newsimg"]["name"],PATHINFO_EXTENSION);

												$filename = time().rand(1111,9999).".".$ext;

												move_uploaded_file($_FILES["newsimg"]["tmp_name"], "uploads/news/".$filename);
												...
												$result = mysqli_query($conn,"insert into 
													tbl_news(Title,Description,News_img) values ('$title','$description','$newsimg')") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											<form class="form" method="post" enctype="multipart/form-data">
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="file" name="newsimg" class="form-control" placeholder="news img" />
													</div>
