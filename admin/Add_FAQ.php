...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage FAQ - Add FAQ</title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<!-- <li class="breadcrumb-item">
												<a href="#" class="text-muted">Manage Add FAQ</a>
											</li> -->
											<li class="breadcrumb-item">
												<a href="Add_FAQ.php" class="text-muted">Add FAQ</a>
											</li>
									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$txtcatid = $_POST["txtfaqcat"];
												



												$result = mysqli_query($conn,"insert into 
													tbl_FAQ(Question,Answer,Faq_cat_id) values('$txtQuestion','$txtAnswer','$txtcatid')") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											<form class="form" method="post">
												<div class="card-body">
													<div class="form-group">
														...
														<select name="txtfaqcat" class="form-control">
