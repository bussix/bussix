...
<head>
		...
		<link href="theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle9cd7.css?v=7.1.5" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="theme/logo.png" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
									...
									<div class="col-lg-12 col-xxl-4">
										...
										<div class="card card-custom bg-gray-100 card-stretch gutter-b">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title font-weight-bolder text-white">Dashboards</h3>
											...
											<div class="card-body p-0 position-relative overflow-hidden">
												...
												<div class="card-spacer mt-n25">
													<!--begin::Row-->
													<div class="row m-0">
														<div class="col-3 bg-light-success px-6 py-8 rounded-xl mr-37 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
																<?php $result=mysqli_query($conn,"select * from tbl_bus") or die (mysqli_error($conn));
										                        ?>
																
																<h2 class="text-warning font-weight-bold font-size-h2"><?php echo mysqli_num_rows($result); ?></h2>
															</span>
															<a href="all_bus.php" class="text-warning font-weight-bold font-size-h6">Buses</a>
														</div>
														<div class="col-3 bg-light-info  px-6 py-8 rounded-xl mr-37 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
																<?php $result=mysqli_query($conn,"select * from tbl_User") or die (mysqli_error($conn));
										                        ?>
																
																<h2 class="text-primary font-weight-bold font-size-h2"><?php echo mysqli_num_rows($result); ?></h2>
															</span>
															<a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">All Users</a>
														</div>
														<div class="col-3 bg-light-danger px-6 py-8 rounded-xl mr-2 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
													...
													<!--begin::Row-->
													<div class="row m-0">
														<div class="col-3 bg-light-danger px-6 py-8 rounded-xl mr-37 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
																<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Media/Equalizer.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<div class="col-3 bg-light-info px-6 py-8 rounded-xl mr-2 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
																<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Media/Equalizer.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						...
						<div class="overlay-layer">
							<a href="index-2.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
		...
		<script src="theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle9cd7.js?v=7.1.5"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="theme/html/demo1/dist/assets/js/pages/widgets9cd7.js?v=7.1.5"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Nov 2020 05:18:11 GMT -->
</html>