...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage FAQ - update FAQ</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Manage FAQ</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										...
										<!-- 	<li class="breadcrumb-item">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">update FAQ</a>
											</li>
								...
								<div class="row">
									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											...
											{
												$faqcatid = $_POST["txtfaqcatid"];
												$question = $_POST["txtquestion"];
												$answer = $_POST["txtanswer"];
										
											$result = mysqli_query($conn,"update tbl_faq set Faq_cat_id ='".$faqcatid."'Question='".$question."',Answer='".$answer."' where tbl_faq = '".$id."'") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											<?php
											$count=1;
											$result = mysqli_query($conn,"select * from tbl_faq where Faq_id ='".$id."'") or die(mysqli_error($conn));
											while($row=mysqli_fetch_assoc($result))
											{
												...
												<div class="card-body">
													<div class="form-group">
														...
														<select type="text" name="txtfaqcatid" class="form-control">
														<!-- <option>Please Select Category</option> -->

												<?php
												$result1 = mysqli_query($conn,"select * from tbl_faq_categery") or die(mysqli_error($conn));
												while($row1=mysqli_fetch_assoc($result1))
												{
												?>
															<option value="<?php echo $row1["Faq_cat_id"]; ?>"><?php echo $row1["Faq_cat_name"]; ?></option>
													...
													<div class="form-group">
														<label>Answer:</label>
													<input type="text" name="txtanswer" class="form-control"value="<?php echo $row["Answer"]; ?>"/>
													</div>
												</div>
