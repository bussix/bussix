	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Active Bus</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">All Active Bus List 
											</h3>
										</div>
			...
			if(isset($_POST["btndelete"]))
			{
				...
				if($result == true)
				{
					echo "<script>window.location='active_bus.php';</script>";
				}
			}
		?>
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_bus where Bus_is_active='Yes'") or die(mysqli_error($conn));
