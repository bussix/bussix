									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_review as r left join tbl_user as u on u.user_id=r.User_id") or die(mysqli_error($conn));
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_review where Rev_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
