							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">All Bus</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="all_bus.php" class="text-muted">All Bus</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">All Bus List 
											</h3>
										</div>
										<div class="card-toolbar">
											...
											<i class="la la-plus"></i>Add New Bus</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="uploads/bus/<?php echo $row["Bus_photos"]?>" height="100" width="150" /></td>
													<td><?php echo $row["Bus_type"]; ?></td>
													<td><?php echo $row["Bus_is_active"]; ?></td>
													<td>
														<a href="update_bus.php?busId=<?php echo $row['Bus_id']; ?>" class="btn btn-primary">Edit</a>
														<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Bus_id"]; ?>" class="btn btn-danger btn-delete">Delete</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_bus where Bus_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
