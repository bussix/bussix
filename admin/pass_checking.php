...
<head>
		...
		<meta charset="utf-8" />
		<title>BRTS | Pass Checking</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Pass </h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="pass_checking.php" class="text-muted">Pass checking</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Pass checking
											</h3>
										</div>
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												as tc left join tbl_pass as p on p.Pass_id=tc.Pass_id
												left join tbl_bus_station as bs on bs.Bus_station_id=tc.Bus_station_id") or die(mysqli_error($conn));
    ...
    <div class="modal-dialog" role="document">
		...
		<?php
			if(isset($_POST["btndelete"]))
			{
				...
				if($result == true)
				{
					echo "<script>window.location='pass_checking.php'</script>";
				}
			}
		?>
