...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage TimeTable | Add TimeTable</title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="add timetable.php" class="text-muted">Add TimeTable</a>
											</li>
										...
										<div class="card card-custom example example-compact">
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"insert into 
													tbl_timetable(Bus_id,Bus_station_id,Timing) values ('$bus_id','$bus_station_id','$timing')") or die(mysqli_error($conn));
												if($result==true)
												{
												...
												<div class="card-body">
													<div class="form-group">
														...
														<option>Please Select Bus Id</option>
															<?php
												$result = mysqli_query($conn,"select * from tbl_bus") or die(mysqli_error($conn));
											...
											<?php } ?>
														...
														<select name="txtbusstationid" class="form-control">
															...
															<?php
												$result = mysqli_query($conn,"select * from tbl_bus_station") or die(mysqli_error($conn));
												while($row=mysqli_fetch_assoc($result))
												{
												?>
											<option value="<?php echo $row["Bus_station_id"]; ?>"><?php echo $row["Bus_station_name"]; ?></option>
											<?php } ?>
														</select>
													</div>
													...
													<div class="form-group">
														<label>Timing</label>
														<input type="text" name="txttiming" class="form-control" placeholder="timing" />
													</div>
