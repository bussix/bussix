							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Complain</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_complaint as c left join tbl_user as u on u.user_id=c.User_id") 
												...
												?>
												   ...
												   <tr>
													...
													<td><?php echo $row["com_img_url"] ?></td>
...
<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_complaint where user_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
