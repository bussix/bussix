...
<head>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Pass booking</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="pass_booking.php" class="text-muted">Pass booking</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">All Pass booking  
											</h3>
										</div>
										...
										<table class="table table-separate table-head-custom">
											<thead>
												<tr>
													<th>#</th>
													<th>Name</th>
													<th>Start location Name</th>
													<th>End location Name</th>
													<th>km</th>
													<th>Total amount</th>
													<th>status</th>
													<th>Actions</th>
											...
											<tbody>
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_pass as p left join tbl_user as u on u.user_id=p.User_id left join tbl_bus_station as bs on bs.Bus_station_id=p.S_location_id") or die(mysqli_error($conn));
												...
												<tr>
													...
													<td><?php echo $row["E_location_id"]; ?></td>
													<td><?php echo $row["km"]; ?></td>
													<td><?php echo $row["total amount"]; ?></td>
													<td><?php echo $row["status"]; ?></td>
													<td>
														<a href="#" class="btn btn-primary">Edit</a>
														<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Pass_id"];?>"class="btn btn-danger btn-delete">Delete</a>
    ...
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_pass where Pass_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
					echo "<script>window.location='pass_booking.php'</script>";
				}
			}
		?>
