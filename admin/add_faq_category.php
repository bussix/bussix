									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"insert into tbl_faq_categery (FAQ_cat_name) values ('$txtcatname')") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											<form class="form" method="post">
												<div class="card-body">
													<div class="form-group">
														...
														<input type="text" name="txtcatname" class="form-control" placeholder="FAQ Category Name" />
													</div>
