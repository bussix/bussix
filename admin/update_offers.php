...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage News - Add Offers</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Manage Offers</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<!-- <li class="breadcrumb-item">
												<a href="#" class="text-muted">Manage Add Offers</a>
											</li> -->
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">update Offers</a>
											</li>
									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											<div class="card-header">
												<h3 class="card-title">update Offers</h3>
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"update
													tbl_offer set Title='".$title."',Description='".$description."',Is_active='".$isactive."',Discount='".$discount."',amount='".$amount."' where Offer_id = '".$id."'") or die(mysqli_error($conn));
												if($result==true)
												{
													echo "Inserted";
												}
											...
											<form class="form" method="post" enctype="multipart/form-data">
												...
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="text" name="txtdescription" class="form-control" value="<?php echo $row["Description"]; ?> " placeholder="description" />
													</div>
														<div class="form-group">
														<label>Isactive</label>
														<select name="txtisactive" class="form-control">
														<option <?php if($row["Is_active"]=="yes"){?>selected="true" <?php } ?>>yes</option>
													    <option <?php if($row["Is_active"]=="no"){?>selected="true" <?php } ?>>no</option>
													    </select>
													</div>
														<div class="form-group">
														<label>Discount</label>
														<input type="text" name="txtdiscount" class="form-control"  value="<?php echo $row["Discount"]; ?> "placeholder="discount" />
													</div>
														<div class="form-group">
														<label>Amount</label>
														<input type="text" name="txtamount" class="form-control" value="<?php echo $row["amount"]; ?> " placeholder="amount" />
													</div>
