...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage FAQ Category - Add FAQ Category</title>
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Manage FAQ Category</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
					...
					$result = mysqli_query($conn,"update tbl_faq_categery set FAQ_cat_name='".$txtcatname."' where Faq_cat_id = '".$id."'") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											<?php
											$count=1;
											$result = mysqli_query($conn,"select * from tbl_faq_categery where Faq_cat_id ='".$id."'") or die(mysqli_error($conn));
											while($row=mysqli_fetch_assoc($result))
											{
												...
												<div class="card-body">
													<div class="form-group">
														...
														" value="<?php echo $row["Faq_cat_name"]; ?>"/>
													</div>
												</div>
