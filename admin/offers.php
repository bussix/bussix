...
<head>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">offers</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="offers.php" class="text-muted">offers</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										...
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="add_offers.php" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>Add offer</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
											...
											<tbody>
												...
												?>
												   ...
												   <tr>
													...
													<td>
														<a href="update_offers.php?offerId=<?php echo $row['Offer_id']; ?> " class="btn btn-primary">Edit</a>
													<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Offer_id"]; ?>"class="btn btn-danger btn-delete">Delete</a>
    ...
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_offers where Offer_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
