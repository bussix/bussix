...
<head>
		...
		<meta charset="utf-8" />
		<title>BRTS | Ticket Booking</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Ticket booking</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="ticket_booking.php" class="text-muted">Ticket booking</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">All booking
											</h3>
										</div>
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_ticket as t left join tbl_user as u on u.user_id=t.user_id 
													left join tbl_bus_station as bs on bs.Bus_station_id=t.s_bus_station_id") or die(mysqli_error($conn));
												...
												<tr>
												    ...
												    <td><?php echo $row["e_bus_station_id"]; ?></td>
													<td><?php echo $row["KM"]; ?></td>
													<td><?php echo $row["Total_amount"]; ?></td>
													<td><?php echo $row["Status"]; ?></td>
													<td>
														<a href="#" class="btn btn-primary">Edit</a>
														<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Ticket_id"];?>" class="btn btn-danger btn-delete">Delete</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_ticket where Ticket_id='$id'") or die(
                mysqli_error($conn));
				if($result == true)
				{
					echo "<script>window.location='ticket_booking.php'</script>";
				}
			}
		?>
		<!--end::Demo Panel-->
