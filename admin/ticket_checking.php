...
<head>
		...
		<meta charset="utf-8" />
		<title>BRTS | Ticket checking</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Ticket Checking</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="ticket_checking.php" class="text-muted">Ticket Checking</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Ticket Checking 
											</h3>
										</div>
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_ticket_check as tc left join tbl_bus_station as bs on bs.Bus_station_id=tc.Bus_station_id left join  tbl_ticket as t on t.Ticket_id=tc.Ticket_id") or die(mysqli_error($conn));
												...
												<tr>
													...
													<td>
														...
														<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Check_id"];?>"class="btn btn-danger btn-delete">Delete</a>
    ...
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_ticket_check where Check_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
					echo "<script>window.location='ticket_checking.php'</script>";
				}
			}
		?>
