								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="add_offers.php" class="text-muted">Add Offers</a>
											</li>
										...
										<div class="card card-custom example example-compact">
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"insert into 
													tbl_offer(Title,Description,Is_active,Discount,amount) values ('$title','$description','$isactive','$discount','$amount')") or die(mysqli_error($conn));
												if($result==true)
												{
													echo "Inserted";
												}
											...
											<form class="form" method="post">
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="text" name="txtdiscount" class="form-control" placeholder="discount" />
													</div>
														<div class="form-group">
														<label>Amount</label>
