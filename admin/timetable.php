							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Time table</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="timetable.php" class="text-muted">Time table</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Time table
											</h3>
										</div>
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="add timetable.php" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>Add Time table</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_timetable as t left join tbl_bus as b on b.Bus_id=t.Bus_id left join tbl_bus_station as bs on bs.Bus_station_id=t.Bus_station_id") or die(mysqli_error($conn));
												...
												?>
												 <tr>
													...
													<td>
														<a href="update_timetable.php?TimeId=<?php echo $row['Time_id']; ?> "class="btn btn-primary">Edit</a>
													<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Time_id"]; ?>"class="btn btn-danger btn-delete">Delete</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_timetable where Time_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
