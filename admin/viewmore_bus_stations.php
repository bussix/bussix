                        ...
                        <div class="col-8">
                           ...
                           <div class="card card-custom example example-compact">
                              <div class="card-header">
                                 <h3 class="card-title">Bus Station Details</h3>
                              </div>
                              <div class="card-body">
                              <?php
                              ...
                              <form class="form" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="row pt-5">
                                    <div class="form-group col-4">
                                       ...
                                       <input type="text" name="txtbusstationname" class="form-control" value="<?php echo $row["Bus_station_name"]; ?>"placeholder="Bus station name" disabled/>
                                    </div>
                                    <div class="col-4">
                                    	&nbsp;
                                    </div>
                                    <div class="form-group col-4">
                                       ...
                                       <input type="text" name="txtbusstaionnumber" class="form-control" value="<?php echo $row["Bus_station_id"]; ?>"placeholder="Bus  station number " disabled />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                       <label>Bus station Photo:</label><br/>
                                       <img src="uploads/busstation/<?php echo $row["Bus_station_photo"]?>" height="50%" width="100%" />
                                    </div>
                                 <div class="form-group">
                                    <label>Address:</label>
                                    <textarea name="txtAddress" class="form-control" placeholder=" Address" disabled><?php echo $row["Bus_station_address"]; ?></textarea>
                                 </div>
                                 <div class="row">
                                    <div class="form-group col-3">
                                       <label>Landmark:</label>
                                       <input type="text" name="txtLandmark" class="form-control" value="<?php echo $row["Bus_station_landmark"]; ?> "placeholder="Landmark" disabled/>
                                    </div>
                                    <div class="form-group col-3">
                                       <label>Pincode:</label>
                                       <input type="text" name="txtPincode" class="form-control" value="<?php echo $row["Bus_station_pincode"]; ?> "placeholder="Pincode" disabled />
                                    </div>
                                    <div class="form-group col-3">
                                       <label>Lattitude:</label>
                                       <input type="Lattitude" name="txtLattitude" class="form-control" value="<?php echo $row["Bus_station_latitude"]; ?> "placeholder="Lattitude" disabled />
                                    </div>
                                    <div class="form-group col-3">
                                       <label>Longtitude:</label>
                                       <input type="Longtitude" name="txtLongtitude" class="form-control" value="<?php echo $row["Bus_station_longtitude"]; ?> "placeholder="Longtitude" disabled />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label>Is Active?:</label>
                                    <input type="text" name="" class="form-control" value="<?php echo $row["bus_station_isactive"]?>" disabled/>
                                 </div>
