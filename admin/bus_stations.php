...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage Bus | Add Bus Stations</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bus Stations</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="col-6">
										...
										<div class="card card-custom example example-compact">
											<div class="card-header">
												<h3 class="card-title">Bus Station</h3>
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"insert into tbl_bus_station (bus_station_name,Bus_station_photo,bus_station_address,bus_station_landmark,bus_station_pincode,bus_station_latitude,bus_station_longtitude,bus_station_isactive, ) values ('$busstationname','$busstationimg','$Address','$Landmark','$Pincode','$Latitude','$Longtitude','$isactive')") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											<form class="form" method="post" enctype="multipart/form-data">
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="text" name="txtbusstationname" class="form-control" placeholder="Bus station name" />
													</div>
													...
													<div class="form-group">
														...
														<label>Bus Station Number:</label>
															<input type="text" name="txtbusstaionnumber" class="form-control" placeholder="Bus  station number " />
														</div>

														<div class="form-group">
														<label>Address:</label>
															<input type="textarea" name="txtAddress" class="form-control" placeholder=" Address" />
														</div>						

															<div class="form-group">
														<label>Landmark:</label>
															<input type="text" name="txtLandmark" class="form-control" placeholder="Landmark" />
														</div>				

														<div class="form-group">
														<label>Pincode:</label>
															<input type="text" name="txtPincode" class="form-control" placeholder="Pincode" />
														</div>	

														<div class="form-group">
														<label>Lattitude:</label>
															<input type="Lattitude" name="txtLattitude" class="form-control" placeholder="Lattitude" />
														</div>	

														<div class="form-group">
														<label>Longtitude:</label>
															<input type="Longtitude" name="txtLongtitude" class="form-control" placeholder="Longtitude" />
														</div>
