...
<head>
		...
		<meta charset="utf-8" />
		<title>BRTS | ALL Inactive Bus station</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Inactive Bus Station</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="inactive_bus_stations.php" class="text-muted">Inactive Bus Stations</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Inactive Bus Stations 
											</h3>
										</div>
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="add_bus.php" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>New Bus Stations</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											<thead>
												<tr>
													...
													<th>Bus Station Photo</th>
													<th>Bus Station Pincode</th>
													<th>Is Active?</th>
													<th>Actions</th>
												</tr>
											</thead>
											<tbody>
												<tr>
														<?php
												$count=1;
											$result = mysqli_query($conn,"select * from tbl_bus_station where bus_station_isactive='No'") or die(mysqli_error($conn));
												while($row=mysqli_fetch_assoc($result))
												{
												?>
												<tr>
													<td><?php echo $count; $count++; ?></td>
													<td><?php echo $row["Bus_station_name"]; ?></td>
												    <td><?php echo $row["Bus_station_photo"]; ?></td>
													<td><?php echo $row["Bus_station_pincode"]; ?></td>
											     	<td><?php echo $row["bus_station_isactive"]; ?></td>
													<td>
														<!-- <a href="#" class="btn btn-primary">Edit</a>
															<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Bus_station_id"]; ?>" class="btn btn-danger btn-delete">Delete</a> -->
...
<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_bus_station where Bus_station_id ='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
					echo "<script>window.location='inactive_bus_stations.php'</script>";
				}
			}
		?>
