								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										...
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="Add_FAQ.php" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>Add FAQ</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												...
												<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_faq as f
											left join tbl_faq_categery as fc on fc.Faq_cat_id=f.Faq_cat_id") or die(mysqli_error($conn));
...
<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from tbl_faq where Faq_id ='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
