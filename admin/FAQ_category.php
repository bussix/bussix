								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="FAQ_category.php" class="text-muted">FAQ Category</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">FAQ Category
											</h3>
										</div>
										<div class="card-toolbar">
											...
											<!--begin::Button-->
											<a href="add_faq_category.php" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i> Add FAQ Category</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom">
											...
											<tbody>
												<tr>
														<?php
												$count=1;
												$result = mysqli_query($conn,"select * from tbl_faq_categery") or die(mysqli_error($conn));
												...
												<tr>
													...
													<td>
													<a href="update_faq_category.php?FaqcatId=<?php echo $row['Faq_cat_id']; ?> "class="btn btn-primary">Edit</a>
														<a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["Faq_cat_id"]; ?>" class="btn btn-danger btn-delete">Delete</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
		...
		<?php
			...
			{
				$id = $_POST["deleteid"];
				$result = mysqli_query($conn, "delete from  tbl_faq_categery where Faq_cat_id='$id'") or die(mysqli_error($conn));
				if($result == true)
				{
					echo "<script>window.location='FAQ_category.php'</script>";
				}
			}
		?>
