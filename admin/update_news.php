...
<head>
		...
		<meta charset="utf-8" />
		<title>Manage News | update News</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Update News</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										...
										<div class="card card-custom example example-compact">
											...
											if(isset($_POST["btnsubmit"]))
											{
												...
												$result = mysqli_query($conn,"update 
													tbl_news set Title='".$title."',Description='".$description."',News_img='".$filename."' where News_id = '".$id."'") or die(mysqli_error($conn));
												if($result==true)
												{
											...
											while($row=mysqli_fetch_assoc($result))
											{
												...
												<input type="text" name="txtdescription" class="form-control "value="<?php echo $row["Description"]; ?>
